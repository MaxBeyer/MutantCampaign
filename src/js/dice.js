...
let sectorTable = new Map();
sectorTable.set(11, thickWoods);
sectorTable.set(12, thickWoods);
sectorTable.set(13, scrublands);
sectorTable.set(14, scrublands);
sectorTable.set(15, scrublands);
sectorTable.set(16, marshlands);
sectorTable.set(21, marshlands);
sectorTable.set(22, deadWoods);
sectorTable.set(23, deadWoods);
sectorTable.set(24, deadWoods);
sectorTable.set(25, ashDesert);
sectorTable.set(26, ashDesert);
sectorTable.set(31, hugeCrater);
sectorTable.set(32, glasifiedField);
sectorTable.set(33, overgrownRuins);
sectorTable.set(34, overgrownRuins);
sectorTable.set(35, overgrownRuins);
sectorTable.set(36, crumblingRuins);
sectorTable.set(41, crumblingRuins);
sectorTable.set(42, crumblingRuins);
sectorTable.set(43, decayedRuins);
sectorTable.set(44, decayedRuins);
sectorTable.set(45, decayedRuins);
sectorTable.set(46, decayedRuins);
sectorTable.set(51, decayedRuins);
sectorTable.set(52, unscathedRuins);
sectorTable.set(53, unscathedRuins);
sectorTable.set(54, unscathedRuins);
sectorTable.set(55, unscathedRuins);
sectorTable.set(56, unscathedRuins);
sectorTable.set(61, derelictIndustries);
sectorTable.set(62, derelictIndustries);
sectorTable.set(63, derelictIndustries);
sectorTable.set(64, derelictIndustries);
sectorTable.set(65, settlement);
sectorTable.set(66, settlement);
...
let rotTable = new Map();
rotTable.set(11, rotOasis);
rotTable.set(12, rotOasis);
rotTable.set(13, weakRot);
rotTable.set(14, weakRot);
rotTable.set(15, weakRot);
rotTable.set(16, weakRot);
rotTable.set(21, weakRot);
rotTable.set(22, weakRot);
rotTable.set(23, weakRot);
rotTable.set(24, weakRot);
rotTable.set(25, weakRot);
rotTable.set(26, weakRot);
rotTable.set(31, weakRot);
rotTable.set(32, weakRot);
rotTable.set(33, weakRot);
rotTable.set(34, weakRot);
rotTable.set(35, weakRot);
rotTable.set(36, weakRot);
rotTable.set(41, weakRot);
rotTable.set(42, weakRot);
rotTable.set(43, weakRot);
rotTable.set(44, weakRot);
rotTable.set(45, weakRot);
rotTable.set(46, weakRot);
rotTable.set(51, weakRot);
rotTable.set(52, weakRot);
rotTable.set(53, weakRot);
rotTable.set(54, weakRot);
rotTable.set(55, weakRot);
rotTable.set(56, rotHeavyArea);
rotTable.set(61, rotHeavyArea);
rotTable.set(62, rotHeavyArea);
rotTable.set(63, rotHeavyArea);
rotTable.set(64, rotHeavyArea);
rotTable.set(65, rotHeavyArea);
rotTable.set(66, rotHeavyArea);
